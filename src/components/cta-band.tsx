...
export function CtaBand({
  ...
  subtitle = "Get a free, no-obligation consultation. Our team responds within one business day — with a firm proposal for your space.",
      ...
      <Reveal className="mx-auto max-w-6xl">
        <div className="glass-card relative overflow-hidden rounded-3xl">
          <div className="absolute inset-0 -z-10">
            <Image
              src={image}
              alt="Freshly harvested vegetables in a wooden crate with garden gloves"
              fill
              sizes="100vw"
