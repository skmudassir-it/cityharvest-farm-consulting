...
export const metadata: Metadata = {
  title: "Services",
  description:
    "Rooftop farm design and build, community garden planning, greenhouse and high-tunnel installation, hydroponic consulting, soil health programs, farm-to-table partnerships and urban farm operations management.",
};
      ...
      <section className="px-4 pb-8 pt-36 sm:pt-40">
        <div className="mx-auto max-w-6xl">
          <SectionHeading
            ...
            title="One team for the life of your farm"
            subtitle="From the first feasibility study to the daily harvest — seven services that take your project from empty space to thriving farm."
          />
        </div>
      </section>
      ...
      <section className="px-4 py-10 sm:py-14">
        <div className="mx-auto max-w-6xl">
          ...
          <Reveal className="mt-14 text-center">
            ...
            >
              Talk to a farm consultant <ArrowRight className="size-4" />
            </Link>
          </Reveal>
        </div>
      </section>
