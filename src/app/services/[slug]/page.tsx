...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: `${service.name} | CityHarvest Farm Consulting`,
      description: service.description,
  ...
  return (
    <>
            ...
            <Reveal delay={0.05}>
              <div className="glass-card rounded-3xl p-7">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Every space is different. We walk the site, run the numbers and give you a firm
                ...
                >
                  Get my firm proposal
                </Link>
              </div>
            </Reveal>
            <Reveal delay={0.1}>
              <div className="glass-card rounded-3xl p-7">
                <h3 className="font-display text-base font-bold text-foreground">Where we work</h3>
                <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                  We build and manage farms across the Portland metro and 40+ cities nationwide —
                  rooftops, lots, schools, restaurants and non-profits. Remote consulting is
      ...
      <CtaBand
        ...
        subtitle="Tell us about your space and we will respond within one business day with a firm, written proposal."
      />
    </>
  );
}
