...
export const metadata: Metadata = {
  title: "Projects",
  description:
    "Case studies from CityHarvest Farm Consulting: rooftop farms, school learning gardens, community garden networks and hydroponic container farms across the region.",
};
      ...
      <section className="px-4 pb-8 pt-36 sm:pt-40">
        <div className="mx-auto max-w-6xl">
          <SectionHeading
            ...
            title="Empty space, turned into working harvests"
            subtitle="A few recent projects that show how we think — deeply engineered, honestly priced and finished on schedule."
          />
        </div>
      </section>
      ...
      <section className="px-4 py-12">
        <div className="mx-auto max-w-6xl">
          <SectionHeading
            ...
            subtitle="Whether you have one empty lot or an 80,000 sq ft tower roof, we would love to talk."
          />
          <Stagger className="mt-10 grid gap-6 sm:grid-cols-3" stagger={0.08}>
            {[
              { k: "1", v: "Tell us about your space — we reply within one business day." },
              { k: "2", v: "We walk the site and hand you a firm written proposal." },
              { k: "3", v: "We build, plant and hand over a growing farm. Warranty starts day one." },
            ].map((s) => (
              <StaggerItem key={s.k}>
